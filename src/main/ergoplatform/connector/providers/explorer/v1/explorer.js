...
var ExplorerClient = /** @class */ (function () {
    ...
    ExplorerClient.prototype.getLatestBlockHeaders = function (num) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUri, "/blocks/headers?limit=").concat(num);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = "".concat(this.baseUri, "/mempool/transactions/submit");
                        options = {
                            method: 'POST',
                            headers: {
    ...
    ExplorerClient.prototype.getLatestBlock = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUri, "/networkState");
                        return [4 /*yield*/, ExplorerClient.api(url)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, {
    ...
    ExplorerClient.prototype.getUnspentOutputs = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var limit, offset, total, result, url, resp, dto;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        limit = 100;
                        ...
                        _a.label = 1;
                    case 1:
                        url = "".concat(this.baseUri, "/boxes/unspent/byAddress/").concat(address, "?offset=").concat(offset, "&limit=").concat(limit);
                        return [4 /*yield*/, ExplorerClient.api(url)];
                    case 2:
                        resp = _a.sent();
                        total = (0, lodash_1.max)([total, resp.total]);
                        dto = resp.items.map(function (i) { return ({
                            id: i.boxId,
                        ...
                        result.push.apply(result, dto);
                        offset += limit;
                        _a.label = 3;
                    case 3:
                        if (result.length < total && total > 0) return [3 /*break*/, 1];
                        _a.label = 4;
    ...
    ExplorerClient.prototype.getAddressSummary = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUri, "/addresses/").concat(address, "/transactions?offset=0&limit=5");
                        return [4 /*yield*/, ExplorerClient.api(url)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                total: result.total,
                                items: result.items.map(function (i) { return ({
                                    id: i.id,
                                    // headerId: i.blockId,
                                    ...
                                    inputs: i.inputs.map(function (x) { return (__assign({ id: x.boxId, txId: x.transactionId }, x)); }),
                                    outputs: i.outputs.map(function (x) { return (__assign({ id: x.boxId, txId: x.transactionId }, x)); }),
                                    size: i.size
                                }); })
                            }];
                }
    ...
    ExplorerClient.prototype.getUnconfirmedTransactions = function (address_1) {
        return __awaiter(this, arguments, void 0, function (address, offset, limit) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUri, "/mempool/transactions/byAddress/").concat(address, "?offset=").concat(offset, "&limit=").concat(limit);
                        return [4 /*yield*/, ExplorerClient.api(url)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
